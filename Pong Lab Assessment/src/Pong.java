...
public class Pong extends Canvas implements KeyListener, Runnable {
	...
	public void paint(Graphics window) {
		...
		if(ball.didCollideTop(rightPaddle)||ball.didCollideTop(leftPaddle)||ball.didCollideBottom(rightPaddle)||ball.didCollideBottom(leftPaddle))ball.setYSpeed(-ball.getYSpeed());
